...
class DVLTModel(
    ...
    def _solve_train_random(self, x, rope_pos, B, S, rng):
        ...
        if self.stochastic_depth > 0:
            ...
            for (start, end), min_count in zip(self._block_ranges, self._min_steps_per_block):
...
class DVLT(Module):
    ...
    def _postprocess_predictions(self, batch, predictions):
        ...
        cameras = [extri_intri_to_cameras(e, i, (H, W)) for e, i in zip(extrinsics_c2w, intrinsics)]
        preds = {
